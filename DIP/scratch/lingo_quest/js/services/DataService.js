...
const STORAGE_KEY = 'circuit_quest_data';
...
window.DataService = {
    ...
    init: async () => {
        try {
            ...
            // Fallback Data so app isn't empty
            window.DataService.questions = [
                { id: 991, topicId: 1, question: "CSV Failed to Load. Run via Local Server.", optionA: "OK", optionB: "Retry", optionC: "Help", answer: "OK", explanation: "Browsers block file:// access." },
                { id: 992, topicId: 8, question: "CSV Failed. This is a fallback Theory Q.", optionA: "True", optionB: "False", optionC: "N/A", answer: "True", explanation: "Fallback." }
            ];

            // Alert User
            setTimeout(() => {
                alert("⚠️ Data Load Failed!\n\nAccessing local files (questions.csv) is blocked by the browser.\n\nPlease run this project using a Local Server (e.g. VS Code 'Live Server').");
            }, 500);
        }
    },
