window.Home = function ({ onStart, topicProgress, onManageProfiles }) {
    ...
    profileBtn.style.fontSize = '0.9rem';
    profileBtn.innerHTML = '👤 Manage Profiles';
    profileBtn.style.marginBottom = '12px';
    profileBtn.onclick = () => {
        if (onManageProfiles) onManageProfiles();
    };

    importContainer.appendChild(profileBtn);
